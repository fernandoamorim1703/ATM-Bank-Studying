...
int OptionsAccounts::newAccount(int idade, int cpf, int nascimento, int tipoConta){
...
int OptionsAccounts::infoAccount(int index){
    return accounts[index]->cpf;
    /*system("clear");
    char tipoConta[9];
